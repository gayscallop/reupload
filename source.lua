...
local drawing = loadstring(game:HttpGet("https://raw.githubusercontent.com/gayscallop/reupload/refs/heads/main/extension.lua"))();
local tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/gayscallop/reupload/refs/heads/main/tween.lua"))() -- shhhh
local signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/gayscallop/reupload/refs/heads/main/signal.lua'))()
...
for i,v in next, images do
    if not isfile(settings.folder_name..'/assets/'..i..'.ln') then
        writefile(settings.folder_name..'/assets/'..i..'.ln', syn.crypt.custom.encrypt(game:HttpGet(v),'4XGudgFuutoHUM2Ctwsq4YrQ','zP5JJWPSIbf5Xuuy','aes-ctr'))
    end
    images[i] = syn.crypt.custom.decrypt(readfile(settings.folder_name..'/assets/'..i..'.ln'),'4XGudgFuutoHUM2Ctwsq4YrQ','zP5JJWPSIbf5Xuuy','aes-ctr')
end
